      ...
      <div>
        {testimonials.map((data) => {
          return (
            <div
              key={data._id}
              className="relative text-theme-dark bg-[#f8f8f8] w-full pt-[3.5rem] pb-40 px-[5%]  xsmall:pt-[5rem] xsmall:pb-32 small:w-[80%] small:max-w-[1121px] small:mx-auto small:pl-[9.5rem]"
            >
              ...
              <div className="absolute invisible bottom-10 left-0 px-[5%] xsmall:px-[50px] w-full h-full z-20 flex justify-between items-end">
                ...
                <div className="flex visible gap-4 xsmall:-rotate-90 xsmall:absolute xsmall:top-1/2 xsmall:right-[2%] small:rotate-0">
