...
export default function ServiceItem({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-theme-dark text-center w-full text-[clamp(2.5rem,6vw,3.2rem)] xsmall:text-[clamp(2.4rem,4.1vw,3.2rem)] xsmall:text-left xsmall:leading-[3.6rem] small:text-[clamp(2.5rem,2.1vw,3.2rem)]">
