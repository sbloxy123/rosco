...
export default function ServiceItem({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-theme-dark w-[100%] small:w-full text-[clamp(2.4rem,6vw,3.2rem)] xsmall:text-[3.2rem] xsmall:leading-[3.6rem] xsmall:w-full small:text-[clamp(2.6rem,2.1vw,3.2rem)]">
