...
export default function BorderedImageAbout({
  ...
  return (
    <div className="relative w-full h-auto small:max-w-[700px] medium:mr-0 medium:ml-auto">
      ...
      <div className="absolute top-[0.1%] left-[0%] w-[98.5%] aspect-[342.7/365] overflow-hidden xsmall:w-[calc(100%+0.6%)] xsmall:left-[-0.5%]  xsmall:absolute xsmall:aspect-[690/451] small:w-[calc(100%+1.2%)] small:relative small:aspect-[703/454] small:mt-0">
        <Image
