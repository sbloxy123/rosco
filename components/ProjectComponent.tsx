  ...
  return (
    <div className="block relative z-0 text-white">
      <div
        ...
        className="relative  bg-[image:var(--image-url)] bg-cover w-full h-auto group -z-10 px-[5%] py-[4rem] small:px-layout-small"
      >
        <div className="small:w-[clamp(720px,64vw,930px)] mx-auto flex flex-col">
          ...
          <div className="relative order-2 xsmall:pt-[3.4rem] small:order-1 small:-mt-[27rem] small:pt-0">
            ...
            <div className="uppercase tracking-[0.06em] hidden small:block absolute top-[0rem] -right-[0rem] rotate-90 text-theme-dark translate-x-[clamp(117px,12vw,157px)] translate-y-[100%] ">
          ...
          <p className="order-3 pt-[4rem] xsmall:order-4 small:order-3">
