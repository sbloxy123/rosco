        ...
        return (
          <div key={content.aboutPage._id} className="my-10 w-screen">
            <div className="relative bg-theme-dark w-full h-auto aspect-[390/504] xsmall:aspect-[744/416] small:aspect-[1440/504]">
              ...
              ></div>
              <div className="relative px-[5%] pt-[4vw] text-white max-w-[1065px] mx-auto small:px-0 z-10">
            ...
            <div className="z-10 bg-theme-purple mx-auto aspect-[358/200] w-[90%] xsmall:aspect-[646/174] small:max-w-[1065px] -translate-y-[45%] small:-translate-y-[35%]">
            ...
            <div className="px-[5%] small:max-w-[1065px] mx-auto small:px-0">
